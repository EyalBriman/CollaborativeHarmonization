...
all_valid_qualities = {'': '^', '5': '^', '2': '^', 'add9': '^', '+': '+', 'o': 'o', 'h': 'h', 'sus': '^', '^': '^',
                       '-': '-', '^7': '^7', '-7': '-7', '7': '7', '7sus': '7', 'h7': 'h7', 'o7': 'o7', 'o^7': 'o^7',
                       '^9': '^7', '^13': '^7', '6': '^6', '69': '^6', '^7#11': '^7', '^9#11': '^7', '^7#5': '+^7',
                       '-6': '-6', '-69': '-6', '-^7': '-^7', '-^9': '-^7', '-9': '-7', '-11': '-7', '-7b5': 'h7',
                       'h9': 'h7;', '-b6': '-', '-#5': '-', '9': '7', '7b9': '7', '7#9': '7', '7#11': '7', '7b5': '7',
...
all_pitches_reverse = {0: 'C', 1: 'C#', 2: 'D', 3: 'Eb', 4: 'E', 5: 'F', 6: 'F#', 7: 'G', 8: 'Ab', 9: 'A',
                       10: 'Bb', 11: 'B'}
